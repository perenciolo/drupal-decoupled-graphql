...
class ReportController extends ControllerBase
{
    ...
    protected function load()
    {
        ...
        $select->join('users_field_data', 'u', 'r.nid = u.uid');
    ...
    {
        $content = array();
        $content['message'] = array('#markup' => $this->t('Below is a list of all Event RSVPs including username, email address and the name of the event they will be attending.'));
